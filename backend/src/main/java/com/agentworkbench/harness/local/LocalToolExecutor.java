...
public class LocalToolExecutor {
     ...
     */
    public String execute(Long sessionId, String toolName, String arguments, String workspace, boolean needApproval) {
        ...
        try {
            return sessionRegistry.sendToolRequest(sessionId, toolName, arguments, workspace, needApproval).get();
        } catch (Exception e) {
