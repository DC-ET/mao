<template>
  <Teleport to="body">
    ...
    >
      ...
      <div v-if="showOpenInFinder" class="context-menu-divider"></div>
      <div v-if="showOpenInFinder" class="context-menu-item" @click="$emit('open-in-finder')">
      ...
      <div v-if="showDownloadActions" class="context-menu-item" @click="$emit('download-file')">
...
[data-theme="dark"] .git-context-menu {
  background: #2a2a2a;
