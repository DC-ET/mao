...
const HELP = `用法:
  mao quick-command list [--agent-id <id>]
  mao command list
  mao command get --id <id>
  mao command create --name <名称> --content <内容>
  mao command update --id <id> [--name <名称>] --content <内容>
  mao command delete --id <id>
`;
