...
const HELP = `用法:
  mao file upload --file <路径> [--session-id <id>]
  mao file list [--session-id <id>]
  mao file delete --id <id>
  mao file download --id <id> --out <路径>
  mao file workspace-list --session-id <id> [--filter] [--limit]
  mao file workspace-directory --session-id <id> [--dir]
  mao file workspace-read --session-id <id> --path <相对路径> [--offset] [--limit]
  mao file workspace-git-status --session-id <id>
  mao file workspace-git-diff --session-id <id> --path <相对路径>
  mao file project-list --project-key <key> [--filter] [--limit]
`;
