...
const HELP = `用法:
  mao weixin binding-status
  mao weixin qrcode
  mao weixin qrcode-status --session-key <key>
  mao weixin binding-confirm --session-key <key> --bot-token <token> --ilink-base-url <url> --ilink-user-id <id>
  mao weixin unbind
`;
