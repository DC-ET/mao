...
```bash
mao pref task-panel get --json
```

---

## 命令：mao pref task-panel set
...
```bash
mao pref task-panel set --group-order running,recent,archived --collapsed-groups archived
```

---

## 命令：mao pref task-notification get
...
```bash
mao pref task-notification get --json
```

---

## 命令：mao pref task-notification set
...
```bash
mao pref task-notification set --enabled true --channel DINGTALK --webhook-url 'https://oapi.dingtalk.com/robot/send?access_token=...'
mao pref task-notification set --enabled false
```

---

## 命令：mao pref task-notification test
...
```bash
mao pref task-notification test --channel FEISHU
```

---

## 命令：mao pref weixin get
...
```bash
mao pref weixin get --json
```

---

## 命令：mao pref weixin set
...
```bash
mao pref weixin set --enabled true
mao pref weixin set --enabled false
```
