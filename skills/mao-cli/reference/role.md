...
```bash
mao role create --name 运营 --code ops --description '运营人员'
```
...
```bash
mao role update --id 2 --name 高级运营 --description '更新说明'
```
...
```bash
mao permission list
mao role assign-permissions --id 2 --permission-ids 1,2,3,5
```
