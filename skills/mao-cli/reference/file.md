...
```bash
mao file upload --file ./note.pdf --session-id 12
```
...
```bash
mao file delete --id 8
```

---

## 命令：mao file download
...
```bash
mao file download --id 8 --out /tmp/a.pdf
```

---

## 命令：mao file workspace-list
...
```bash
mao file workspace-list --session-id 12 --filter '*.ts' --limit 50
```

---

## 命令：mao file workspace-directory
...
```bash
mao file workspace-directory --session-id 12 --dir src
```

---

## 命令：mao file workspace-read
...
```bash
mao file workspace-read --session-id 12 --path README.md --offset 0 --limit 2000
```

---

## 命令：mao file project-list
...
```bash
mao file project-list --project-key demo --limit 30
```

---

## 命令：mao file workspace-git-status
...
```bash
mao file workspace-git-status --session-id 12 --json
```

---

## 命令：mao file workspace-git-diff
...
```bash
mao file workspace-git-diff --session-id 12 --path src/main.ts --json
```
