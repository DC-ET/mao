---
name: mao-admin-cli
description: 通过 mao-admin CLI 操作 Mao 管理后台 API，覆盖鉴权、用户角色、Agent、模型、Skill、会话监控、分析审计与通知。
---
...
| 通知 | [reference/notification.md](reference/notification.md) |
