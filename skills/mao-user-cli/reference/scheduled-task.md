...
## 命令：mao-user scheduled-task list
...
```bash
mao-user scheduled-task list --json
```

---

## 命令：mao-user scheduled-task get
...
```bash
mao-user scheduled-task get --id 3 --json
```

---

## 命令：mao-user scheduled-task update
...
```bash
mao-user scheduled-task update --id 3 --status PAUSED
mao-user scheduled-task update --id 3 --cron-expression '0 0 9 * * *'
```

---

## 命令：mao-user scheduled-task delete
...
```bash
mao-user scheduled-task delete --id 3
```
