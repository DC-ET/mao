...
## 命令：mao-user weixin binding-status
...
```bash
mao-user weixin binding-status --json
```

---

## 命令：mao-user weixin qrcode
...
```bash
mao-user weixin qrcode --json
```

---

## 命令：mao-user weixin qrcode-status
...
```bash
mao-user weixin qrcode-status --session-key abc --json
```

---

## 命令：mao-user weixin binding-confirm
...
```bash
mao-user weixin binding-confirm --session-key abc --bot-token token --ilink-base-url https://... --ilink-user-id wxid
```

---

## 命令：mao-user weixin unbind
